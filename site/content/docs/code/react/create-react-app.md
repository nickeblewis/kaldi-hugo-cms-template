...
The new README.md that is generated with all of this is well worth a look and here at H4C we are going to dig deep and see what we can do with it. So I have included the contents of that file below and will edit it to show my own thoughts and observations where necessary
